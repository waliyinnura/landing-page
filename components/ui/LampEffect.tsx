...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-100 dark:bg-slate-950 w-full rounded-md z-50",
        className
      )}
    >
      <motion.div
        className="absolute top-[25%] z-50"
        initial={{ opacity: 0 }}
